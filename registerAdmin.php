...
if(isset($_GET['dob']))
    ...
    { 
        $supervisor= mysqli_real_escape_string($con, $_GET['supervisor']);
    }

//query string
$query= mysqli_query($con,
"Insert into admin (FirstName,LastName,Gender,DOB,Email,Username,Password,Country,City,PhoneNumber,DLNumber,DExperience,DCompany) values
('$fname','$lname','$gender','$dob','$email','$username','$password','$country','$city','$mobile','$dlnumber','$dexp','$dcompany')
");
